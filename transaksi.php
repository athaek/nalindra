...
<?php
	...
	else if (isset($_GET['action']) && $_GET['action']=="return_penjualan") {
		include "return_penjualan.php";
	}else if (isset($_GET['action']) && $_GET['action']=="cari_barang") {
		...
		<div class="bgwhite">
			...
			<div class="contenttop">
				<div class="left">
					...
					<a href="?action=return_penjualan" class="btnblue" style="background: #f33155"><i class="fa fa-mail-reply"></i> Return Penjualan</a>
				</div>
				<div class="both"></div>
			</div>
			...
			<tbody>
				...
				while ($f=$q->fetch_assoc()) {
					...
					<tr>
						...
						<td>Rp. <?= number_format($f['biaya_pengiriman']) ?></td>
