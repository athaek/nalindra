	...
	<div class="padding">
		<div class="bgwhite">
			<div class="padding">
				...
				<?php } ?>
				<?php
				$getqheader=$root->con->query("select supplier.nama_supplier,return_pembelian.tgl_return_pembelian,return_pembelian.no_invoice from return_pembelian inner join supplier on supplier.id_supplier = return_pembelian.id_supplier where id_return_pembelian='$_GET[id_return_pembelian]'");
				...
				<table>
					...
					<tr>
						...
						<td><span class="label"><?= date("d-m-Y",strtotime($getqheader['tgl_return_pembelian'])) ?></span></td>
					</tr>
					<tr>
				...
				$data=$root->con->query("select barang.nama_barang,barang.stok,barang.harga_beli,detail_return_pembelian.jumlah_beli,detail_return_pembelian.total_harga from detail_return_pembelian inner join barang on barang.id_barang = detail_return_pembelian.id_barang where detail_return_pembelian.id_return_pembelian='$_GET[id_return_pembelian]'");
				$getsum=$root->con->query("select * from return_pembelian where id_return_pembelian='$_GET[id_return_pembelian]'");
