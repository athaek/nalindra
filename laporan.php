...
<?php
	...
	}elseif (isset($_GET['action']) && $_GET['action']=="chart_pen") {
		include "chart_pen.php";
	}
	else{
?>
...
<div class="content">
    ...
    <form action="cetak_laporan.php" style="display: inline;" target="_blank" method="post">
					...
					<a href="?action=chart_pen" class="btnblue" style="background: #f33155"><i class="fa fa-mail-reply"></i>Grafik</a>
					</form>
				</div>
				<div class="both"></div>
			</div>
