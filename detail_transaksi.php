...
<div class="content">
	<div class="padding">
		<div class="bgwhite">
			<div class="padding">
				...
				$data=$root->con->query("select barang.nama_barang,barang.harga_jual,sub_transaksi.jumlah_beli,sub_transaksi.total_harga,sub_transaksi.diskon,sub_transaksi.harga_set from sub_transaksi inner join barang on barang.id_barang=sub_transaksi.id_barang where sub_transaksi.id_transaksi='$_GET[id_transaksi]'");
				...
				$query3=$root->con->query("select * from transaksi where id_transaksi='$_GET[id_transaksi]'");
	$pengsub=$query3->fetch_assoc();
				...
				?>
				<tr>
					<td></td><td></td><td></td><td></td><td></td><td>Biaya Pengiriman :</td><td> Rp. <?= number_format($pengsub['biaya_pengiriman']) ?></td>
				</tr>
				<tr>
					<td></td><td></td><td></td><td></td><td></td><td>Sub Total :</td><td> Rp. <?= number_format($getsum1['grand_total']) ?></td>
				</tr>
					<tr>
					<td></td><td></td><td></td><td></td><td></td><td>Grand Total :</td><td> Rp. <?= number_format($getsum1['grand_total']+$pengsub['biaya_pengiriman']) ?></td>
				</tr>
